...
// Update
app.put('/api/cart/:id', cart.updateCart);
...
// Get all suppliers
app.get('/api/suppliers', suppliers.readSuppliers);

// Get a specific supplier
app.get('/api/suppliers/:id', suppliers.readSupplier);

// Update a supplier
app.put('/api/suppliers/:id', suppliers.updateSupplier);

// Delete a supplier
//app.delete('/api/suppliers/:id', suppliers.DeleteSupplier);
